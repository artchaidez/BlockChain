...
Some code was also from Prof Elliot's BlockInputG.java. Prof stated to keep links in code, even
though I did not use use these.
...
public class ProjectA {
    ...
    public String data;
    private int nonce;      //IntelliJ saying this is not used? can't comment it out either
    public static int difficulty = 5;   //how tough the "work" is.
    public static ArrayList<ProjectA> blockchain = new ArrayList<>();
    // from Prof Elliot's BlockInputG.java
    UUID uuid;

    public ProjectA(String data,String previousHash  ) {
    ...
    * signature as a string. This will work for previous and current hash. */
    ...
    //Not Needed until ProjectI. I will change code when I get there
    ...
    * is why it took so long. Increasing difficultly */
    ...
    public static void addBlock(ProjectA newBlock) {
    ...
    public static Boolean isChainValid() {
        ProjectA currentBlock;
        ProjectA previousBlock;
    ...
    public static void main(String[] args) {
        ...
        addBlock(new ProjectA("Block 0: ", "0"));

        System.out.println("Mining block 1... ");
        addBlock(new ProjectA("Block 1: ",blockchain.get(blockchain.size()-1).hash));

        System.out.println("Mining block 2... ");
        addBlock(new ProjectA("Block 2: ",blockchain.get(blockchain.size()-1).hash));

        System.out.println("Mining block 3... ");
        addBlock(new ProjectA("Block 3: ",blockchain.get(blockchain.size()-1).hash));
        ...
        System.out.println("\nThe block chain: ");
        System.out.println(blockchainJson); //show the blocks in order
    }
