/* Combines code from previous projects with Prof Elliot's bc.java
ProjectJ built upon ProjectI. Considered deleting unused code, but future me
will appreciate not having to re-add it later on.
...
public class ProjectJ {
    ...
    public ProjectJ(String data, String previousHash  ) {
...
//From ProjectH. Added portBase and port for blocks
class Ports {
